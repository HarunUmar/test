...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendor/metisMenu/metisMenu.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendor/bootstrap-multiselect/bootstrap-multiselect.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendor/parsleyjs/css/parsley.css')); ?>">
    <!-- MAIN CSS -->
...
<body>
    ...
    <div id="wrapper">
       ...
       <?php echo $__env->make('layouts.foother', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
    <!-- END WRAPPER -->
    <!-- Javascript -->
       <script src="<?php echo e(asset('assets/vendor/jquery/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/bootstrap/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/metisMenu/metisMenu.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/jquery-sparkline/js/jquery.sparkline.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/bootstrap-progressbar/js/bootstrap-progressbar.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/vendor/chartist-plugin-axistitle/chartist-plugin-axistitle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/chartist-plugin-legend-latest/chartist-plugin-legend.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/toastr/toastr.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/scripts/common.js')); ?>"></script>
    <script>
    $(function() {
